...
class CharacteristicsController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->validate())  {
            if ($model->save()) {
                ...
                Yii::$app->getSession()->setFlash('alert','<div class="alert alert-success">Техническая характеристика добавлена!</div>');
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->validate()) {
            if ($model->save()) {
                ...
                Yii::$app->getSession()->setFlash('alert','<div class="alert alert-success">Информация сохранена!</div>');
    ...
    public function actionDelete($id)
    {
		...
		return $this->redirect('/admin/characteristics/index');
