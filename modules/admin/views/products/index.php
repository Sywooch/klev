...
$this->title = $title;
$this->params['breadcrumbs'][] = ['label' => 'Продукты', 'url' => ['/admin/products/index']];
...
<div class="products-index">
    ...
    <p><a href="/admin/products/configurator_create">Добавить товары через конфигуратор</a></p>
    <p><a href="/admin/products/configurator_update">Обновить каталог через конфигуратор</a></p>
    <hr>
    <p>
