...
function init () {
    var custom_center1 = [];
    if ($('#ispobjects-geo').val()){
        var inp = $('#ispobjects-geo').val().split(',');
        custom_center1[0] = inp[0];
        custom_center1[1] = inp[1];
    }else{
        custom_center1[0] = 55.819543;
        custom_center1[1] = 37.611619;
    }
    var map = new ymaps.Map('map', {
            center: [custom_center1[0],custom_center1[1]],
            zoom: 15
        }, {
        ...
        map.events.add('actiontick',function(mapEventObject){
            markerPosition[0] = markerElement.offset().left +16;
            markerPosition[1] = markerElement.offset().top+18;
            ...
            if (containsPoint(mapGlobalPixelBounds, markerGlobalPosition)) {
                ...
                $('.field-ispobjects-geo input').val(geoPosition);
            }
