...
CountdownTimer.prototype={
 initialize:function(elm,tl,mes) {
  ...
  if( ( this.tl - today ) > 0 ){
   timer += '<span class="number-wrapper"><div class="line"></div><div class="caption">Дней</div><span class="number day">'+this.addZero(day)+'</span></span>';
...
function CDT(){
 ...
 // Set countdown limit
 var tl = new Date('2017/10/07 18:00:00');
