...
class CharacteristicsSort extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['characteristic_id', 'cat_id', 'sort'], 'required'],
            [['characteristic_id', 'cat_id', 'sort'], 'integer'],
        ];
    }
    ...
    public function getCatsforhars(){
        return $this->hasOne(CharacteristicsForCats::className(),['characteristic_id'=>'characteristic_id','cat_id'=>'cat_id']);
    }
